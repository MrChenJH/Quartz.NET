...
{
    public class SqlHeplerFrom
    {

        //连接字符串
        public static string strConn = ConfigurationManager.ConnectionStrings["sqlconfrom"].ToString();
    ...
    public class SqlHeplerTo
    {

        //连接字符串
        public static string strConn = ConfigurationManager.ConnectionStrings["sqlconto"].ToString();
